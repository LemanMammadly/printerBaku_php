        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-blogs mb-30">
                    <div class="blog-img">
                        <a href="pro-details.html"><img src="{{asset('front/assets/img/gallery/blog1.jpg')}}" alt=""></a>
                    </div>
                    <div class="blogs-cap">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-blogs mb-30">
                    <div class="blog-img">
                        <a href="pro-details.html"><img src="{{asset('front/assets/img/gallery/blog2.jpg')}}" alt=""></a>
                    </div>
                    <div class="blogs-cap">
                        <span>Fashion Tips</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-blogs mb-30">
                    <div class="blog-img">
                        <a href="pro-details.html"><img src="{{asset('front/assets/img/gallery/blog3.jpg')}}" alt=""></a>
                    </div>
                    <div class="blogs-cap">
                        <span>Fashion Tips</span>
                        <h5><a href="pro-details.html">What Curling Irons Are The Best Ones</a></h5>
